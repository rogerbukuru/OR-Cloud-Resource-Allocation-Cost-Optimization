...
ggplot(objective_df, aes(x = Iteration, y = Objective_Value)) +
  ...
  labs(title = "Objective Function Convergence Over Iterations (Geometric Cooling)",
       x = "Iteration",
...
ggplot(task_counts, aes(x = factor(1), y = factor(Assigned_Server), fill = Num_Tasks)) +
  ...
  labs(title = "Task Assignments Heatmap (Geometric Cooling)",
       x = "",
       y = "Server ID",
...
ggplot(task_counts_sa, aes(x = factor(Assigned_Server), y = Num_Tasks)) +
  ...
  labs(title = "Number of Tasks Assigned to Each Server (Geometric Cooling)",
       x = "Server ID",
       y = "Number of Tasks") +
  theme_minimal() +
